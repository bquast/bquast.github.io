...
The standalone shiny app ([repository](https://github.com/bquast/Iris-App)) is slightly more complex in the sense that the input widgets are shiny code (which is actually very similar).
