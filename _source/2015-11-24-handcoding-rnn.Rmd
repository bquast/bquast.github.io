...
for (j in 1:10000) {
  ...
  for (position in 0:binary_dim) {
    ...
    layer_2_deltas = rbind(layer_2_error * sigmoid_output_to_derivative(layer_2), layer_2_deltas)
    overallError = overallError + abs(layer_2_error[0])
    
    # decode estimate so we can print it out
    d[binary_dim - (position - 1)] = round(layer_2)
  ...
  for (position in 0:binary_dim) {
    ...
    synapse_1_update = synapse_1_update + synapse_1_update %*% layer_2_delta
